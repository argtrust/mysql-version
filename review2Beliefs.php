...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="review1Scenario.php?sessionID=<?php echo $sessionID;?>&timestep=<?php echo $timestep;?>">Read Scenario</a></li>
    ...
    <div class="container">
        <?php
            $sql = "select scenario_text from user_session where sessionID = '".$sessionID."';";
#            echo $sql;
            $result=mysqli_query($link,$sql);

            if ($result) {
                while ($row = mysqli_fetch_array($result)) {
                    echo "printing scneario";
                    echo $row[0];
                }
