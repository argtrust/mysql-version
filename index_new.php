...
<html lang="en">
  <head>
    ...
    <title>Getting Started - ArgTrust</title>
      ...
      <div class="jumbotron">
        <h1>Welcome to ArgTrust!</h1>
      		<form action="upload.php" method="post" enctype="multipart/form-data">
                <p>Enter UserID: <input type="text" name="userid" id="userid" value="" size="" /> </p>
                <p>Upload File: <input type="file" name="file" id="file"> </p>
                <p><input class="btn btn-lg btn-primary" type="submit" name="submit" value="Get Started  &raquo;"></p>
            </form>
      </div>
