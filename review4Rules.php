...
<html lang="en">
  <head>
    ...
    <title>Review Rule - ArgTrust</title>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="review4Rules.php?sessionID=<?php echo $sessionID;?>&timestep=<?php echo $timestep;?>">Review Rules</a></li>
		...
		document.observe('dom:loaded', function() {
            <?php
                ...
                $sql = "select distinct concat('fact',b.beliefID) as beliefName, CASE
                        ...
                        from beliefs b
                        inner join agent_has_beliefs ab on b.beliefID = ab.beliefID and ab.isInferred = 0 and isRule = 1
                ...
                ";
                $newArray = array_merge($qagnt_rules_end_argument,$qagnt_rules_not_end_argument);
